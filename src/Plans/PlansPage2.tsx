  ...
  return (
    <View style={planscss.view}>
      ...
      <View style={planscss.buton}>
        <TouchableOpacity style={[planscss.touc, { marginTop: '20%', opacity: isContinueButtonDisabled ? 0.5 : 1 }]} disabled={isContinueButtonDisabled} onPress={() => navigation.navigate('PlansPage3')}>
